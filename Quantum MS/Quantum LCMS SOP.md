...
<div style="page-break-after: always;"></div>
6. The image below shows where to locate the Tune Method.  Change the Tune Method to the appropriate tune file that was created from the optimization of your sample.  You have to first clear the directory listed by "Tune Method" before the ellipsis will allow browsing.
